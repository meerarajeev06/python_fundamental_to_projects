...
| **Day 2** | Saving & Reading Data | `json`, `csv`, File Handling | ⏳ In Progress | [View Code](./02-Day2-Data-Handling/) |
| **Day 3** | Fetching Web Data & APIs | `requests`, REST APIs, JSON Parsing | ⏳ In Progress  | [View Code](./03-Day3-APIs-Requests/) |
| **Day 4** | Web UI Development | `streamlit`, Web Elements |⏳ In Progress  | [View Code](./04-Day4-Streamlit-Web/) |
